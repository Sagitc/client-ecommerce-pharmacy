    ...
    <div class="footer__container max-width">
        ...
        <div class="footer__wrapper1">
            <nav class="footer__nav">
                <h2 class="footer__nav-title">Serviços</h2>
                <ul>
                    <li><a href="#">Aferição de pressão</a></li>
                    <li><a href="#">Farmácia popular</a></li>
                    <li><a href="#">Programas de desconto</a></li>
                    <li><a href="#">Aplicação de injetáveis</a></li>
                    <li><a href="#">Teste de glicemia</a></li>
                    <li><a href="#">Furos de orelha</a></li>
                </ul>
            </nav>

            <nav class="footer__nav">
                <h2 class="footer__nav-title">Institucional</h2>
                <ul>
            ...
            <nav class="footer__nav">
                <h2 class="footer__nav-title">Privacidade</h2>
                <ul>
                    <li><a href="#">Termos de uso</a></li>
                    <li><a href="#">Política de privacidade</a></li>
                    <li><a href="#">Utilização de cookies</a></li>
                </ul>
            </nav>
