    ...
    public function run(): void
    {
        Category::where('slug', 'medicamento')->first()->subcategory()->createMany([
            ...
            [
                ...
                'slug' => 'gripe-e-resfriado'
            ],
            [
                'name' => 'Digestivos e Intestinais',
                'slug' => 'digestivos-e-intestinais'
            ],
            [
            ...
            [
                'name' => 'Alergias e Respiratórios',
                'slug' => 'alergias-e-respiratorios'
            ],
            [
            ...
            [
                'name' => 'Uso Contínuo e Controlados',
                'slug' => 'uso-continuo-e-controlados'
            ]
        ]);
        ...
        Category::where('slug', 'higiene-e-cuidados-pessoais')->first()->subcategory()->createMany([
            ...
            [
                'name' => 'Desodorantes e Antitranspirantes',
                'slug' => 'desodorantes-e-antitranspirantes'
            ],
            [
                'name' => 'Higiene Íntima',
                'slug' => 'higiene-intima'
        ...
        Category::where('slug', 'mamae-e-bebe')->first()->subcategory()->createMany([
            [
                'name' => 'Fraldas e Trocadores',
                'slug' => 'fraldas-e-trocadores'
            ],
            [
            ...
            [
                ...
                'slug' => 'alimentacao-infantil'
            ],
            [
                'name' => 'Higiene do Bebê',
                'slug' => 'higiene-do-bebe'
            ],
            [
                'name' => 'Acessórios',
                'slug' => 'acessorios'
        ...
        Category::where('slug', 'dermocosmeticos-e-beleza')->first()->subcategory()->createMany([
            [
                ...
                'slug' => 'cuidados-com-o-rosto'
            ],
            [
                'name' => 'Cuidados com o Corpo',
                'slug' => 'cuidados-com-o-corpo'
            ],
            [
                'name' => 'Maquiagem e Acessórios',
                'slug' => 'maquiagem-e-acessorios'
            ]
        ]);

        Category::where('slug', 'saude-e-bem-estar')->first()->subcategory()->createMany([
            [
                'name' => 'Aparalhos de Saúde',
                'slug' => 'aparalhos-de-saude'
            ],
            [
            ...
            [
                'name' => 'Produtos Naturais e Chás',
                'slug' => 'produtos-naturais-e-chas'
            ]
        ]);
    }
}
